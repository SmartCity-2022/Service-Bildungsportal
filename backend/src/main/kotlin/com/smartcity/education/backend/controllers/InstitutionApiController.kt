...
class InstitutionApiController {
    ...
    fun allLocationsOfInstitution( @PathVariable("id") id: Int
    ...
    fun createInstitution( @Valid @RequestBody institution: Institution
): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    fun createLocationOfInstitution( @PathVariable("id") id: Int
, @Valid @RequestBody location: Location
    ...
    fun singleInstitution( @PathVariable("id") id: Int
    ...
    fun updateInstitution( @PathVariable("id") id: Int
