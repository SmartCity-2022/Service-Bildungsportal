...
class EducationApiController {
    ...
    fun addQualificationsOfEducation( @PathVariable("id") id: Int
, @Valid @RequestBody requestBody: List<Int>
    ...
    fun allAssessmentsOfEducation( @PathVariable("id") id: Int
    ...
    fun allMatriculationsOfEducation( @PathVariable("id") id: Int
    ...
    fun allQualificationsOfEducation( @PathVariable("id") id: Int
    ...
    fun createAssessmentOfEducation( @PathVariable("id") id: Int
, @Valid @RequestBody assessment: Assessment
    ...
    fun createMatriculationOfEducation( @PathVariable("id") id: Int
, @Valid @RequestBody matriculation: Matriculation
    ...
    fun removeQualificationsOfEducation( @PathVariable("educationId") educationId: Int
, @PathVariable("qualificationId") qualificationId: Int
    ...
    fun updateEducationOfLocation( @PathVariable("id") id: Int
